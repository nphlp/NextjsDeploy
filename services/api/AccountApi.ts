...
export const AccountFindFirstApi = async <T extends Prisma.AccountFindFirstArgs>(
    ...
    try {
        const params: AccountFindFirstProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AccountFindUniqueApi = async <T extends Prisma.AccountFindUniqueArgs>(
    ...
    try {
        const params: AccountFindUniqueProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AccountFindManyApi = async <T extends Prisma.AccountFindManyArgs>(
    ...
    try {
        const params: AccountFindManyProps<T> = decodeParams(request.nextUrl.searchParams);
...
export const AccountCountApi = async <T extends Prisma.AccountCountArgs>(
    ...
    try {
        const params: AccountCountProps<T> = decodeParams(request.nextUrl.searchParams);
