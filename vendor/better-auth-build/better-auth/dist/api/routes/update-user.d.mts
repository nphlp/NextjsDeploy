...
declare const cancelEmailChange: better_call0.StrictEndpoint<"/cancel-email-change", {
  method: "POST";
...
declare const verifyEmailChange: better_call0.StrictEndpoint<"/verify-email-change/:userId/:token", {
  method: "GET";
  query: z.ZodObject<{
    callbackURL: z.ZodOptional<z.ZodString>;
  }, z.core.$strip>;
