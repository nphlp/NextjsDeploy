...
import { cancelEmailChange, changeEmail, changePassword, deleteUser, deleteUserCallback, setPassword, updateUser, verifyEmailChange } from "./routes/update-user.mjs";
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: OverrideMerge<{
    ...
    readonly cancelEmailChange: better_call0.StrictEndpoint<"/cancel-email-change", {
      method: "POST";
      body: zod.ZodOptional<zod.ZodObject<{}, zod_v4_core0.$strip>>;
      use: ((inputContext: better_call0.MiddlewareInputContext<better_call0.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
            id: string;
    ...
    readonly verifyEmailChange: better_call0.StrictEndpoint<"/verify-email-change/:userId/:token", {
      method: "GET";
      query: zod.ZodObject<{
        callbackURL: zod.ZodOptional<zod.ZodString>;
      }, zod_v4_core0.$strip>;
...
//#endregion
export { APIError, type AuthEndpoint, type AuthMiddleware, accountInfo, callbackOAuth, cancelEmailChange, changeEmail, changePassword, checkEndpointConflicts, createAuthEndpoint, createAuthMiddleware, createEmailVerificationToken, deleteUser, deleteUserCallback, error, formCsrfMiddleware, freshSessionMiddleware, getAccessToken, getEndpoints, getIp, getOAuthState, getSession, getSessionFromCtx, getShouldSkipSessionRefresh, isAPIError, linkSocialAccount, listSessions, listUserAccounts, ok, optionsMiddleware, originCheck, originCheckMiddleware, refreshToken, requestOnlySessionMiddleware, requestPasswordReset, requestPasswordResetCallback, requireOrgRole, requireResourceOwnership, resetPassword, revokeOtherSessions, revokeSession, revokeSessions, router, sendVerificationEmail, sendVerificationEmailFn, sensitiveSessionMiddleware, sessionMiddleware, setPassword, setShouldSkipSessionRefresh, signInEmail, signInSocial, signOut, signUpEmail, unlinkAccount, updateSession, updateUser, verifyEmail, verifyEmailChange, verifyPassword };