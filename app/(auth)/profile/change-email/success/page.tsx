            ...
            <Card className="max-w-80">
                <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="space-y-2 text-center">
                        <h1 className="text-xl font-semibold">Email de v&eacute;rification envoy&eacute;</h1>
                        <p className="text-sm text-gray-500">
                            Cliquez sur le lien dans l&apos;email envoy&eacute; &agrave; votre nouvelle adresse pour
                    ...
                    <div className="w-full space-y-3 rounded-lg bg-gray-50 p-4 text-sm text-gray-600">
                        <div className="flex items-start gap-2.5">
                            ...
                            <p>
                                Votre adresse email ne sera modifi&eacute;e qu&apos;apr&egrave;s avoir cliqu&eacute; sur
                                le lien de v&eacute;rification.
                            </p>
                        </div>
                        <div className="flex items-start gap-2.5">
