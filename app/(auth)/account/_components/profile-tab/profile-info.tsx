...
import PendingEmailRow from "./pending-email-row";
...
export default function ProfileInfo(props: ProfileInfoProps) {
    ...
    // SSR-first: fall back to server session until client session arrives.
        ...
        <div className="flex w-full items-center justify-between gap-4">
            <Card className="flex-row flex-wrap items-end justify-between py-4">
                <div>
                    ...
                    {pendingEmail && <PendingEmailRow pendingEmail={pendingEmail} onCancelled={refetch} />}
                </div>
