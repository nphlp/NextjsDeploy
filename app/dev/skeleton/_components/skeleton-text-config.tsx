...
export default function SkeletonTextConfig(props: { debugTextSkeleton: boolean }) {
    const { debugTextSkeleton } = props;

    return (
        <div>
            <div className={cn("flex w-120 items-start justify-start", !debugTextSkeleton && "gap-2")}>
